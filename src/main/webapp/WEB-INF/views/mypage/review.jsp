...
<div id="header"></div>
  <div class="review-container">
    ...
    <div class="review-box">
      <div class="review-date">2023. 3. 6 리뷰</div>
  ...
  <div id="script"></div>
	  ...
	  $(document).ready(function(){
	    $("head").load("/resources/mypage/review.html");
